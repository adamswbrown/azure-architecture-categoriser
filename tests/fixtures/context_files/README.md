...
This directory contains **synthetic** sample context files for testing and demonstrating the Azure Architecture Recommender.

## About Context Files

In production, context files are generated by [Dr. Migrate](https://drmigrate.com) during the migration planning process. When you [assess an application with AppCat](https://learn.drmigrate.com/docs/using-dr-migrate/migration-planning/appcat-github-integration/), Dr. Migrate automatically generates a JSON context file containing application metadata, detected technologies, server details, and modernization assessment results.

The sample files in this directory are **synthetically generated** to:
- Demonstrate different migration scenarios without requiring Dr. Migrate
- Provide test fixtures for automated testing
- Show the expected JSON structure for integration purposes

For real-world usage, always use context files generated by Dr. Migrate to ensure accurate recommendations.
